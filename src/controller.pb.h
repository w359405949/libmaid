...
// optional bool wide = 8;
inline bool Controller::has_wide() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void Controller::set_has_wide() {
  _has_bits_[0] |= 0x00000080u;
}
inline void Controller::clear_has_wide() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void Controller::clear_wide() {
  wide_ = false;
  clear_has_wide();
}
inline bool Controller::wide() const {
  return wide_;
}
inline void Controller::set_wide(bool value) {
  set_has_wide();
  wide_ = value;
}

// optional int32 depth = 9;
inline bool Controller::has_depth() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void Controller::set_has_depth() {
  _has_bits_[0] |= 0x00000100u;
}
inline void Controller::clear_has_depth() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void Controller::clear_depth() {
  depth_ = 0;
  clear_has_depth();
}
inline ::google::protobuf::int32 Controller::depth() const {
  return depth_;
}
inline void Controller::set_depth(::google::protobuf::int32 value) {
  set_has_depth();
  depth_ = value;
}
