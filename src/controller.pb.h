...
inline ::google::protobuf::int32 ControllerMeta::transmit_id() const {
  return transmit_id_;
}
inline void ControllerMeta::set_transmit_id(::google::protobuf::int32 value) {
  set_has_transmit_id();
  transmit_id_ = value;
}

// optional bool stub_side = 4;
inline bool ControllerMeta::has_stub_side() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void ControllerMeta::set_has_stub_side() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ControllerMeta::clear_has_stub_side() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void ControllerMeta::clear_stub_side() {
  stub_side_ = false;
  clear_has_stub_side();
}
inline bool ControllerMeta::stub_side() const {
  return stub_side_;
}
inline void ControllerMeta::set_stub_side(bool value) {
  set_has_stub_side();
  stub_side_ = value;
}
