...
_CONTROLLER = descriptor.Descriptor(
  name='Controller',
  full_name='maid.proto.Controller',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='service_name', full_name='maid.proto.Controller.service_name', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='method_name', full_name='maid.proto.Controller.method_name', index=1,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='transmit_id', full_name='maid.proto.Controller.transmit_id', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='stub_side', full_name='maid.proto.Controller.stub_side', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='is_canceled', full_name='maid.proto.Controller.is_canceled', index=4,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='failed', full_name='maid.proto.Controller.failed', index=5,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='error_text', full_name='maid.proto.Controller.error_text', index=6,
