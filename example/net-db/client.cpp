...
public:
    ...
    void DoRun()
    {
        ...
        printf("get: %s, %s\n", request->key().c_str(), response->value().c_str());
    }
...
int main()
{
    ...
    open_request->set_db_name("testdb");
    ...
    put_request->set_key("first_key");
    put_request->set_value("first_value");
    ...
    delete_request->set_key("first_key");
